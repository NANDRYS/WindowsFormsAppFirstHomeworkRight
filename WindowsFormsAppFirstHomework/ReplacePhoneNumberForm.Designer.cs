...
{
    partial class ReplacePhoneNumberForm
    {
        /// <summary>
    ...
    "жный контакт";
            ...
            this.Name = "ReplacePhoneNumberForm";
            this.Text = "ReplacePhoneNumberForm";
            this.Load += new System.EventHandler(this.ReplacePhoneNumberForm_Load);
